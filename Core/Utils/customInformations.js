function showError(errorType, errorMessage, errorStack)
{
    ...
    console.error(`\x1b[1m\x1b[38;2;255;0;0m[DETAILS] ${errorStack == null ? "Active debug mode to see the stack.\x1b[0m" : `${errorStack.toLowerCase() == "none" ? `No stack available.\x1b[0m` : `\x1b[0m${errorStack}`}`}`);
}
